...
class Navigation {
  ...
  public function custom_nav_attributes( $atts ){
	...
	public function custom_nav_walker( $nav_output, $nav, $args ) {
		...
		$small_menu_button = '<div class="title-bar" data-responsive-toggle="nav-menu-primary" data-hide-for="medium" style="display: none;"><button class="menu-icon" type="button" data-toggle="nav-menu-primary"></button><div class="title-bar-title">Menu</div></div>';
